        ...
        <div class="authentication-inner row">
            ...
            <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <!-- /Logo -->
                    <h3 class="mb-1 fw-bold">Daftarkan Akun Anda!</h3>
                    <p class="mb-4">Belum memiliki akun? Daftarkan akun Anda!</p>
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ url('register') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-secondary">*nama pengguna mengggunakan huruf besar semua</small>
                        </div>
